...
# selectbox
df_shops['display_name'] = df_shops['nombre'] + " (" + df_shops['local'] + ")"
selected = st.selectbox("Heladería", df_shops['display_name'].sort_values())

shop_row = df_shops[df_shops['display_name'] == selected].iloc[0]
